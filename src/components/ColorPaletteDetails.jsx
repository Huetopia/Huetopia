      ...
      {palette !== null && (
        <>
          <div className="flex justify-between">
            ...
            {favourite === true
              ? <button onClick={favouriteHandler} className="btn btn-sm fill-none btn-ghost p-0 hover:btn-outline-none hover:bg-transparent ">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:fill-red-500" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
              </svg>
            </button>
            
              : <button onClick={favouriteHandler} className="btn btn-sm fill fill-red-500 btn-ghost p-0 hover:btn-outline-none hover:bg-transparent ">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:fill-none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
              </svg>
            </button>
            }
